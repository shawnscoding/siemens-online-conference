...
- System Design
- Talk to clients and project manager, review a project proposal and ponder if the requirements are feasible by the deadline.  
...
- Back-up, sql statement automation using Crontab in Linux
- User Authentication
